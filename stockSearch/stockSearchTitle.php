...
$code = $_GET['code'];
$stock = mysql_query("SELECT name,date,close FROM stock_market.stock_price_data where code='$code' and date=(select max(date) from stock_market.stock_price_data where code='$code');");
