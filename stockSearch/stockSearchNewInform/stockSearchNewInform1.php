...
<div>
    <button onclick="formSubmit('stocktech1')">月營收</button>
    <button onclick="formSubmit('stocktech2')">月營收年增率</button>
    <button onclick="formSubmit('stocktech3')">每股盈餘</button>
    <button onclick="formSubmit('stocktech4')">利潤比率</button>
    <button onclick="formSubmit('stocktech5')">本益比</button>
    <button onclick="formSubmit('stocktech6')">殖利率</button>
</div>
<div class="container">
    <div>
