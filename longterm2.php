...
<html>
    ...
    <div class="container">
        ...
        <button type="button" onclick="calculate()" class="button button4">開始計算</button>
    ...
    function calculate(){
        ...
        var amountInvested = parseInt(document.getElementById("amountInvested").value);
        ...
        var l2 = (roi - wageGrowth)/100;
        var accumalated = deposit * Math.pow((1+l2),(i - workAge)*12) + amountInvested * (1+l2) * (Math.pow((1+l2),(i - workAge)*12)-1) / 12;
